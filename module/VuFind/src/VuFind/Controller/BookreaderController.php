...
class BookreaderController extends AbstractBase
{
    ...
    public function viewerAction()
    {
        ...
        if ($this->_bookID) {
            $client = new Client('https://opac.libfl.ru/ALISAPI/Books/' . $this->_bookID, array(
                'maxredirects' => 0,
                'timeout' => 30
            ));
        ...
        if ($this->_orderID) {
            ...
            $client = new Client('https://opac.libfl.ru/ALISAPI/Circulation/Orders/ById/' . $this->_orderID, array(
                'maxredirects' => 0,
                'timeout' => 30
            ));
            $client->setMethod('GET');
            ...
            if ($response->isSuccess()) {
                ...
                $client = new Client('https://opac.libfl.ru/ALISAPI/Books/ElectronicCopy/' . $orderInfo->Book->ID, array(
                    'maxredirects' => 0,
                    'timeout' => 30
                ));
                $client->setMethod('GET');
